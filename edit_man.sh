...
TERMINFO="/home/smalik/arm-gcc/opt/FriendlyARM/toolschain/4.4.3//share/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /home/smalik/Downloads/arm/ncurses/ncurses-5.9/man_alias.sed ; then
cat >>/home/smalik/Downloads/arm/ncurses/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/smalik/Downloads/arm/ncurses/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/smalik/Downloads/arm/ncurses/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /home/smalik/Downloads/arm/ncurses/ncurses-5.9/man_alias.sed \
		< $i >$TMP
